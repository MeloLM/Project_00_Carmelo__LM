    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8">
                <h3 class="display-5 text-center">Inserisci una nuova asta:</h3>
                <form class="p-5 shadow" action="{{route('trade.store')}}" method="POST" enctype="multipart/form-data"> 
                ...
                <form action="{{route('trade.index')}}">
                    <button type="submit" class="btn btn-outline-info">Torna Indietro</button>
                </form>
            </div>
        </div>
    </div>
